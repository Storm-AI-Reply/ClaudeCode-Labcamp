...
This file is the contract between your team and Claude. When Claude edits
...
> your team's real theme. The `design-system` skill will auto-apply it
> to any HTML/CSS work.
...
## Visual identity (placeholder: replace with your team's theme)
...
- **Never write to `live/`.** This directory holds snapshots of quizzes that
  ...
  player sessions. A PreToolUse hook enforces this automatically, but the
  rule holds regardless of tooling.
